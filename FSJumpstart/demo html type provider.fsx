// TypeProviders : See https://www.nuget.org/packages/FSharp.Data
// With Visual Studio,  open Package Manger Console  and run >Install-Package FSharp.Data 
#r """..\packages\FSharp.Data.2.3.2\lib\net40\FSharp.Data.dll"""

open FSharp.Data

type MarketDepth = HtmlProvider<"MarketDepth.htm">


// Download the latest market depth information
//let bmr = "http://www.bmreports.com/servlet/" + "com.logica.neta.bwp_MarketDepthServlet"
//let mrktDepth = MarketDepth.Load(bmr).Tables.Table1
let mrktDepth = MarketDepth.Load("MarketDepth.htm").Tables.Table1
